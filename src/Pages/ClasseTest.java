...
public class ClasseTest {
	...
	public void testIntMedInvalidPassword() throws Exception{
		...
		assertEquals("Aten��o!", driver.findElement(locator).getText());
	}
	...
	public void testInsertCurso() throws Exception{
		...
		cursosPage.openPage();
		cursosPage.fillDescricao("Especializa��o");
	...
	public void testInsertExperiencia() throws Exception{
		...
		experienciaPage.fillCargo("M�dico");
		experienciaPage.fillBreveDescricao("M�dico");
